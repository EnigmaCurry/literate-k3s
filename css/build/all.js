...
var org_html_manager = {
  ...
  setup: function ()
  {
    ...
    //EnigmaCurry hack to always push URL anchor hash when clicking headers.
    //When livereload triggers, it will reload to the last position clicked.
    var headers=['H1','H2','H3','H4','H5','H6'];
    window.addEventListener("click", function(e){
      if (headers.indexOf(e.target.tagName) >= 0){
