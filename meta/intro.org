...
#+end_example
 ...
 at the very bottom of this file under the =Footnotes= section (not visible in
 HTML export). The =Local Variables= is a formal way to inform Emacs that you
 ...
 section at the bottom of the =Footnotes= section, and you will no longer see
...
export HTML whenever the file is saved, see the =Footnotes= section. You can
...
configuration when it loads that other files rely upon. See the =Footnotes=
section.)
